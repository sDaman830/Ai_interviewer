  ...
  ({ role, peerId, scrollToBottom }, listRef) => {
    ...
    if (messages.length === 0) {
      return (
        ...
        >
          <Text>
Welcome to the AI interview by Hireboud. Click "Next" to Start the question. After you answer it, click "Next" to move to the next question. Please record your previous response.</Text>
        </Flex>
      );
    }
